...
| ------------------------- |---------- | ------------------------------------------------------ |
| Авторизация / Регистрация | Условно   | Работает, но **пароли не хэшируются** — **уязвимость** |
| Защита от SQL-инъекций    |           | Используются `PreparedStatement`                       |
| Разделение ролей          |           | Админ-защита есть                                      |
| Админка / Каталог         |           | Реализовано корректно                                  |
| Структура проекта         |           | Логичная, чистая                                       |
